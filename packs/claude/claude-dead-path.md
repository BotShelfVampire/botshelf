# Dead path scan — Claude Code pack (free)

Find dead paths in the repo. Don't rewrite until Yes.
...
## Do
- Scan for href and src that miss a file.
- List them.
- Keep missing files missing.
...
## Stop conditions
Rewrite, push, and deploy wait for Yes.
