# README opening — Claude Code pack (free)

README opening from the code. Don't invent APIs.
...
- Write the opening from what exists.
- List commands you actually saw.
