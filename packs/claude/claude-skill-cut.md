# Skill cut — Claude Code pack (free)

Cut one skill file. Don't dump 20 rules.
...
## Do
- Cut one job into CLAUDE.md or the named skill file.
- Keep Do, Don't, and stop.
- Leave buyer blanks empty.
