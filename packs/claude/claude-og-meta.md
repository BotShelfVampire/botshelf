# OG meta — Claude Code pack (free)

Write OG meta for one page. Don't deploy until Yes.
...
## Do
- Read the page.
- Write title, description, image, alt.
- Keep English OG on English pages.

## Don't
- Deploy.
- Put Japanese on English OG.
- Invent a screenshot.
