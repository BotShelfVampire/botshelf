# i18n key audit — Claude Code pack (free)

Match i18n keys to copy. Don't patch until Yes.
...
## Do
- Diff keys vs copy files.
- List missing, extra, and leaked strings.
- Quote file and key.
...
## Stop conditions
Patch, push, and deploy wait for Yes.
