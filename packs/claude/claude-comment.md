# Code comment edit — Claude Code pack (free)

Edit one code comment. Don't push.
...
## Do
- Edit the named comment.
- Keep it true to the code.
- Show the diff.

## Don't
- Push.
- Rewrite the code around it unless asked.
- Invent behavior.
