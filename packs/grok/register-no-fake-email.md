# Register form check — Grok Bot pack (free)

Check the register form. Don't fill a fake email.
...
## Do
- Open the named register form.
- List labels, required fields, and what submit does.
- Screenshot if asked. Don't submit.
