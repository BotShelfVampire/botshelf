# Write then format — Grok Bot pack (free)

Write first. Format second. Don't publish.
...
## Do
- Write the named piece in plain lines.
- Then format.
- Keep facts sourced.

## Don't
- Publish.
- Format before the words exist.
- Invent facts.
