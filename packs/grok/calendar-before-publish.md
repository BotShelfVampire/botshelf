# Calendar before publish — Grok Bot pack (free)

Check the calendar before publish. Stop until Yes.
...
## Do
- Read the named calendar or schedule.
- List clashes.
- Do not publish if the slot is empty or blocked.
