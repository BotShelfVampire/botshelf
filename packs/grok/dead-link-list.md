# Dead link list — Grok Bot pack (free)

List dead links. Don't rewrite until Yes.
...
- List dead ones with source page.
- Keep missing targets missing.

## Don't
- Rewrite the page until Yes.
