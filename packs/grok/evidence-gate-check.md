# Evidence check — Grok Bot pack (free)

Check proof of a real run. Missing proof = omit.
...
## Do
- Look for a screenshot, log, or recorded run.
- If proof is missing, omit the claim.
- Write what proof you saw.
