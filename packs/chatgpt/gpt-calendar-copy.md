# Calendar copy — ChatGPT pack (free)

Check the calendar before publish copy. Stop until Yes.
...
## Do
- Read the named schedule.
- List clashes.
- Do not write a go-live if the slot is blocked.
