# Register copy — ChatGPT pack (free)

Check register copy. Don't invent emails.
...
## Do
- Rewrite labels from named facts.
- Keep email private if that is true.
- Don't submit.
...
## Stop conditions
Submit and publish wait for Yes.
