# SEO title — ChatGPT pack (free)

Write one SEO title. Don't publish until Yes.
...
## Do
- Write one title from named facts.
- Stay inside the length.
- Keep English on English pages.

## Don't
- Publish.
- Invent a keyword pile.
- Put Japanese on an English title.
